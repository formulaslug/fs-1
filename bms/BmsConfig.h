...
#define PIN_BMS_FLT 0
#define PIN_BMS_FLT_LAT 1
#define PIN_IMD_STATUS 0
#define PIN_IMD_FLT_LAT 8

#define LINE_BMS_FLT PAL_LINE(GPIOB, PIN_BMS_FLT)
#define LINE_BMS_FLT_LAT PAL_LINE(GPIOF, PIN_BMS_FLT_LAT)
#define LINE_IMD_STATUS PAL_LINE(GPIOF, PIN_IMD_STATUS)
#define LINE_IMD_FLT_LAT PAL_LINE(GPIOA, PIN_IMD_FLT_LAT)
...
#define PIN_CAN_RX 11

#define LINE_CAN_TX PAL_LINE(GPIOA, PIN_CAN_TX)
#define LINE_CAN_RX PAL_LINE(GPIOA, PIN_CAN_RX)
